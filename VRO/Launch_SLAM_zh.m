...
for f=g_start_frame:g_total_frames %300%1399; %825; %295  % limited data
    ...
    if e == 0 % succeed
        %% weather it is a small movement
        b_small_move = small_transformation(t);
        if b_small_move == 1 % dismiss small transformation
            fprintf('VRO give small trans: %f %f %f %f %f %f\n', t);
            continue;
        end
