function [noiseModels,isam,result,nextPoseIndex] = VisualISAMInitialize_SIM(data,truth,options)
...
noiseModels.pose = noiseModel.Diagonal.Sigmas([0.034 0.034 0.034 0.0125 0.0125 0.0125]');
noiseModels.odometry = noiseModel.Diagonal.Sigmas([0.034 0.034 0.034 0.0125 0.0125 0.0125]');
