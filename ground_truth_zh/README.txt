...
4. new functions
	generate_gt_trajectory.m 
		INPUT: .log file include TPattern points extracted by extractTPattern.m
		OUTPUT: .log file [timestamp x, y, z, qx, qy, qz, qw]
	extractTPattern.m
		INPUT: .csv file generated by the motion capture system
		OUTPUT: .log file contains the extracted points for the TPattern 
	compute_initial_Tnew.m
		find the initial transformation from world coordinate to camera
		Need to tune the parametes in this file when a new TPattern is used
