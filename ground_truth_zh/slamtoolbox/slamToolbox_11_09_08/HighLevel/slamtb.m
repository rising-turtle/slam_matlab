...
%   initialization methods, and possibly extensions to multi-map SLAM. 
%
%   - Expert users may want to add code for real-data experiments. 
%
%   - Read guidelines.pdf before contributing code to the toolbox.
%
%   - Good luck and enjoy!
%
%   See also USERDATA, USERDATAPNT, USERDATALIN. Also consult
%   slamToolbox.pdf in the root directory.
