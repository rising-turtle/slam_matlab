...
function [phi, theta, psi, trans, error, elapsed, match_num, feature_points, pose_std] = localization_sift_ransac_limit_cov_fast_fast_dist2_nobpc_text(image_name, data_name, filter_name, boarder_cut_off, ransac_iteration_limit, valid_ransac, scale, value_type, dm, inc, j, sframe, sequence_data, is_10M_data, dis)
...
%     if pnum <= 12 % 39
%         fprintf('too few matched points for SVD.\n');
%         error=1;
%         phi=0.0; theta=0.0; psi=0.0; trans=[0.0; 0.0; 0.0];
%         elapsed_ransac = 0.0;
%         elapsed_svd = 0.0;
