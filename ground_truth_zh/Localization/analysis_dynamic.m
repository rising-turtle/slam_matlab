...
data_name_list={'pitch', 'pan7', 'roll5','x2', 'y2', 'c1', 'c2','c3','c4','m','kinect_tum','loop_closure_10m','py_xy_data_sr4000'}; % 'x', 'y', 
...
switch data_name
    ...
    case 'kinect_tum'
     ...
     case 'py_xy_data_sr4000'
        ...
        inc_init = 1;
        inc_max = maxData-1;
        unit={'y12_x-8_p-5.3_y5'};
        interval = {[5 -5.3 -8 12]};  %[yaw pitch x y]
    otherwise
...
%     end
    ...
    switch data_name 
        case {'c1', 'c2', 'c3', 'c4','py_xy_data_sr4000'}
