function [rot, trans, state] = find_transform_matrix_e6(pset1, pset2)
...
Xq = V * U';
mdet = det(Xq);
%threshold = 0.00000000000001;  % Dr. Ye's original code
threshold = 1e-6;  % Modified by Soonhac @ 3/12/14
if round(mdet) == 1
    rot = Xq;
    trans = ct1 - rot*ct2;
    state = 1;
