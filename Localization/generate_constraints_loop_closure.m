...
data_name=data_name_list{16};  % 11 = 'etas', 12 = 'loops2', 13='kinect_tum', 14 = 'sparse_feature', 15='loops', 16='swing', 17='swing2', 18='object_recognition', 19='motive'
...
is_10M_data = 1; % 1 if 10M SR4000; 0 if 5M SR4000
...
for inc = 1: inc_max
    ...
    for k=1:maxDegree
        ...
        switch data_name
            ...
            case {'etas','loops','kinect_tum','loops2','sparse_feature','swing','swing2','motive'}
                if fast_lc == 0
