...
switch Lmk.type
    ...
    case 'fhmPnt' 
        % we will convert from framed homogeneous to euclidean.
        
        % Test for linearity:
        Ld = fhmLinearTest(Rob,Sen,Lmk);
        ...
        if Ld < Opt.correct.linTestIdp
            ...
            Map.used(Lmk.state.r(4:11)) = false; % used positions
